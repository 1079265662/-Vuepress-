...
```scss
// sass 导入文件的方式 没有from 直接 @import 导入即可
// 把如下的文件中的代码导入到这个位置
...
![image-20210708193126699](https://i.loli.net/2021/07/08/YTRnbwp9aAr4xEU.png)![image-20210708193137497](https://i.loli.net/2021/07/08/eG7z9u2dKwNvrXx.png)
