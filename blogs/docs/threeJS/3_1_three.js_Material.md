...
* 他的学名也叫 `PBR材质` 是一种非常写实的材质 立体感很棒 渲染的效果非常好 同时消耗性能较大 `PBR`已经成为很多3D渲染引擎的标准，而无论你在任何软件，引擎中使用标准材质时，得到的结果都是一样的。
  * `粗糙度` 和 `金属度` 是该材质的典型内容
...
<img src="https://jinyanlong-1305883696.cos.ap-hongkong.myqcloud.com/202207271941126.png" alt="图片" style="zoom:67%;" />
